...
<div class="text-center">
  <div class="flex justify-center mb-6">
    <div class="relative w-full max-w-md">
      <input id="site-search-box" type="text" placeholder="Search recipes..." class="w-full px-4 py-2 rounded shadow border border-gray-300 focus:ring-2 focus:ring-accent focus:outline-none transition" autocomplete="off">
      <div id="site-search-results" class="absolute left-0 right-0 bg-white border border-gray-200 rounded shadow-lg mt-1 z-50 text-left" style="display:none;"></div>
    </div>
  </div>
...
The goal isn’t gold leaf or Instagram perfection.
It’s real cooking and real baking.
It’s saving money.
It’s making genuinely delicious food.
And most importantly, it’s having a good time in the kitchen.. </p>
  <div class="section-grid">
    <a href="/recipes/cooking/" class="card">🍳 Cooking</a>
    <a href="/recipes/baking/" class="card">🍞 Baking</a>
    <a href="/recipes/sauces/" class="card">🥣 Sauces</a>
  </div>
</div>
